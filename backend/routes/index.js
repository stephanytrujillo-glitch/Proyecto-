...
// Pedidos
const { crearPedido, misPedidos, detallePedido, todosPedidos, actualizarEstado, eliminarPedido } = require('../controllers/pedidosController');
...
router.delete('/admin/pedidos/:id', verifyToken, esAdmin, eliminarPedido);
